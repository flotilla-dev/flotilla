...
class TestBusinessAgentRegistry:
    ...
    def test_register_multiple_agents(
        self, mock_checkpointer, mock_agent_selector, mock_llm
    ):
    ...
    def test_get_agent(self, mock_agent_selector, mock_llm, mock_checkpointer):
    ...
    def test_get_nonexistent_agent(
        self, mock_agent_selector, mock_llm, mock_checkpointer
    ):
    ...
    def test_list_agents(self, mock_agent_selector, mock_llm, mock_checkpointer):
    ...
    def test_select_agent_by_keywords(
        self, mock_agent_selector, mock_llm, mock_checkpointer
    ):
    ...
    def test_select_agent_no_match(
        self, mock_llm, mock_agent_selector, mock_checkpointer
    ):
    ...
    def test_startup_with_no_agents_does_not_error(self, mock_agent_selector):
