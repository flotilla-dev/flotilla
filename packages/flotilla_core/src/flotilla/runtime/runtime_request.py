...
class RuntimeRequest(BaseModel):
    ...
    user_id: str = Field(..., description="The ID of the user that created the request")
    ...
    transport_metadata: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Optional set of transport specifc metadata that may be included in request",
    )
